...
urlpatterns = [
    ...
    path("<int:m_pk>/volume/<int:volume>/chapter/<int:chapter>/page/<int:page>/", ChapterDetailView.as_view(),
         name="chapter_detail"),
    re_path(r"^chapter/create/$", ChapterCreateView.as_view(), {'manga': None}, name="chapter_create"),
    path("chapter/create/<int:manga>/", ChapterCreateView.as_view(), name="chapter_create_manga_bounded"),
